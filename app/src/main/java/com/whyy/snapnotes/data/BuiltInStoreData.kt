...
val BUILTIN_STORE_ITEMS = listOf(
    StoreSubject(
        ...
        entries = listOf(
            ...
            StoreEntry(id = 4, title = "采薇", desc = "春秋时期《诗经·小雅·采薇》写戍卒归途中所思所感，表现士兵思乡与卫国之情。"),
            ...
            StoreEntry(id = 13, title = "登高", desc = "唐代杜甫所作七言律诗，被誉为古今七律第一。"),
            ...
            StoreEntry(id = 17, title = "琵琶行（并序）", desc = "唐代白居易的长篇乐府诗，写琵琶女的身世和诗人的贬谪之叹，表现了天涯沦落人之感。"),
            StoreEntry(id = 18, title = "春江花月夜", desc = "唐代张若虚所作的乐府旧题诗，以月照春江的夜景为背景，融诗情画意哲理于一体，被称为孤篇盖全唐。"),
            ...
            StoreEntry(id = 40, title = "窦娥冤（节选）", desc = "元代关汉卿的杂剧代表作，写窦娥被冤枉的故事，揭露了封建社会的黑暗与腐败。"),
